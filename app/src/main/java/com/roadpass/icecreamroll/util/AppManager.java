...
import com.roadpass.icecreamroll.interfaces.AppDeleteListener;
import com.roadpass.icecreamroll.interfaces.AppUpdateListener;
...
public class AppManager {
    ...
    private class AsyncGetApps extends AsyncTask {
        ...
        protected void onPostExecute(Object result) {
            ...
            _apps.removeIf(n-> n._className.equals("com.roadpass.icecreamroll.activity.onboardactivity.OnBoardActivity"));
            _nonFilteredApps.removeIf(n-> n._className.equals("com.roadpass.icecreamroll.activity.onboardactivity.OnBoardActivity"));
